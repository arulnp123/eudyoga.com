            ...
            <div class="page-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="{{ url('list_result_type') }}">Result type
                                    </a></li>
                                <li class="breadcrumb-item active" aria-current="page"> <a
                                        href="{{ url('add_new_type') }}"></a> Add
                                    new result type </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <div class="card-body d-flex align-items-center ">
                        ...
                        <p class="card-text h4 ms-2">result type FORM</p>
                    </div>
                        ...
                        <div class="input-group mb-3 p-2">
                            <select name="salary_period" id="salary_period" required class="form-control form-select"
                                ...
                                @foreach ($get_result_type as $key => $get_result_type_list)
                                    <option  @if($get_result_type_list->result_type == $result->result_type ) selected @endif value="{{ $get_result_type_list->result_type }}">
                                        {{ $get_result_type_list->result_type }}</option>
                                @endforeach
                        ...
                        <div class=" d-flex">
                            <div class="form-check ms-3 ">
                                <label class="form-check-label " for="is_default">
                                    <input type="radio" @if ($result->is_default == 1) checked @endif name="is_default"
                            ...
                            <div class="form-check ms-3">
                                <label class="form-check-label" for="is_default">
                                    <input type="radio" @if ($result->is_default == 0) checked @endif name="is_default"
                            ...
                            <div class=" d-flex ">
                                <div class="form-check ms-4 ">
                                    <label class="form-check-label " name="is_active" id="is_active1">
                                        <input type="radio" @if ($result->is_active == 1) checked @endif
                                        name="is_active"
                                ...
                                <div class="form-check ms-3">
                                    ...
                                    <label class="form-check-label" for="is_active2">
                                        <input type="radio" @if ($result->is_active == 0) checked @endif
                                        name="is_active"
