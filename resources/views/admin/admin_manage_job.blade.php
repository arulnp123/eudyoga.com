                    ...
                    <table class="default-table manage-job-table">
                      ...
                      @foreach($jobs_post_new as $job)
                        <tr>
                          ...
                          <td>{{ $job->created_at }}/{{ $job->deadline_date }}</td>
                          <td class="status">{{ $job->status }}</td>
                          <td>
                            <div class="option-box">
                              <ul class="option-list">
                           
                                <li><a  href="{{ url('/admin_edit_job',$job->id) }}" type="button" class="theme-btn btn-style-one small" fdprocessedid="m3qoqi">view</a> </li>
                                <li><a  href="{{ url('/approvejob',$job->id) }}" type="button" class="theme-btn btn-style-one small" fdprocessedid="m3qoqi">Accept</a> </li>
