            ...
            <div class="page-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="{{ url('list_functional_areas') }}">Functional Area
                                    </a></li>
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <div class="card-body d-flex align-items-center ">
                        ...
                        <p class="card-text h4 ms-2">Functional Area FORM</p>
                    </div>
                    ...
                    <form action="{{ url('update_functional_areas') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @foreach ($edit_functional_areas as $functional_area)
                            ...
                            <div class="input-group  p-2">
                                ...
                                <select name="lang" id="lang" required class="form-control form-select"
                                    ...
                                    @foreach ($get_functional_areas as $key => $get_functional_areas_list)
                                        <option @if ($get_functional_areas_list->lang == $functional_area->lang) selected @endif
                                            value="{{ $get_functional_areas_list->lang }}">
                                            {{ $get_functional_areas_list->lang }}</option>
                                    @endforeach
                            ...
                            <div class="mt-4">
                                <p class="h6 ps-3">Functional Area</p>
                            </div>
                            ...
                            <div class="input-group  p-2">
                                ...
                                <select name="functional_area" id="functional_area" required
                                    ...
                                    @foreach ($get_functional_areas as $key => $get_functional_areas_list)
                                        <option @if ($get_functional_areas_list->functional_area == $functional_area->functional_area) selected @endif
                                            value="{{ $get_functional_areas_list->functional_area }}">
                                            {{ $get_functional_areas_list->functional_area }}</option>
                                    @endforeach
                            ...
                            <div class=" d-flex">
                                <div class="form-check ms-3 ">
                                    <label class="form-check-label " for="is_default">
                                        <input type="radio" @if ($functional_area->is_default == 1) checked @endif
                                ...
                                <div class="form-check ms-3">
                                    <label class="form-check-label" for="is_default">
                                        <input type="radio" @if ($functional_area->is_default == 0) checked @endif
                                ...
                                <div class=" d-flex ">
                                    <d6iv class="form-check ms-4 ">
                                        <label class="form-check-label " name="is_active" id="is_active1">
                                            <input type="radio" @if ($functional_area->is_active == 1) checked @endif
                                    ...
                                    <div class="form-check ms-3">
                                        ...
                                        <label class="form-check-label" for="is_active2">
                                            <input type="radio" @if ($functional_area->is_active == 0) checked @endif
