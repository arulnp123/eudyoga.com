                    ...
                    <form action="{{ url('update_degree_types') }}" method="POST">
                        ...
                        @foreach ($edit_degree_types as $key => $edit_degree_types_list)
                            ...
                            <div class="input-group  p-2">
                                @foreach ($edit_degree_level as $key => $edit_degree_level_list)
                                    <select name="salary_period" id="salary_period" required
                                        ...
                                        @foreach ($get_degree_level as $key => $get_degree_level_list)
                                            <option @if ($get_degree_level_list->degree_level == $edit_degree_level_list->degree_level) selected @endif
