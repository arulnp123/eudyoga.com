            ...
            <div class="page-content">
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <form action="{{ url('save_genders') }}" method="POST">
                        ...
                        <div>
                            <p class="h6 ps-3">Select Genders</p>
                        </div>

                        <div class="input-group mb-3 p-2">
                            <select name="gender" id="gender" required class="form-control form-select"
                                aria-label="Default select example">
                                <option value=""> Select Genders </option>
                                @foreach ($add_genders as $key => $genderslist)
                                    <option value="{{ $genderslist->gender }}">
                        ...
                        <div class="input-group mb-3 p-2">
                            <select name="lang" id="lang" required class="form-control form-select"
                                ...
                                @foreach ($add_genders as $key => $genderslist)
                                    <option value="{{ $genderslist->lang }}">
                                        {{ $genderslist->lang }}</option>
                                @endforeach
