            ...
            <div class="page-content">
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <div class="input-group mb-3 p-2">
                        ...
                        <div class="input-group mb-3 p-2">
                            <select name="ownership_type" id="ownership_type" required class="form-control form-select"
                                aria-label="Default select example">
                                <option value="" selected>OwnerShip Type</option>
                                @foreach ($add_ownership_types as $key => $add_ownership_types_list)
                                    <option value="{{ $add_ownership_types_list->ownership_type_id }}">
                                        {{ $add_ownership_types_list->ownership_type }}</option>
                                @endforeach
