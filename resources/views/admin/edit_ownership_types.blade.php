            ...
            <div class="page-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="{{ url('list_result_type') }}">Ownership Type
                                    </a></li>
                                <li class="breadcrumb-item active" aria-current="page"> <a
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <div class="card-body d-flex align-items-center ">
                        ...
                        <p class="card-text h4 ms-2">OWNERSHIP TYPE FORM</p>
                    </div>
                    ...
                    <form action="{{ url('update_ownership_types') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @foreach ($edit_ownership_types as $edit)
                            ...
                            <div class="input-group mb-3 p-2">
                                <select name="ownership_type" id="ownership_type" required
                                    ...
                                    @foreach ($get_ownership_types as $key => $get_ownership_types_list)
                                        <option @if ($get_ownership_types_list->ownership_type == $edit->ownership_type) selected @endif
                                            value="{{ $get_ownership_types_list->ownership_type }}">
                                            {{ $get_ownership_types_list->ownership_type }}</option>
                                    @endforeach
