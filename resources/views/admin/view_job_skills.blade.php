                                ...
                                <div class="card-body">
                                    ...
                                    <div class="bs-stepper-content">
                                        ...
                                        <form action="#" enctype="multipart/form-data">
                                            @csrf
                                            @foreach ($view_job_skills as $key => $view_job_skills_list)
                                                <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane"
                                                    aria-labelledby="stepper2trigger1">
                                                    <h5 class="mb-1">Job Skill</h5>
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <input type="text" class="form-control" name="lang"
                                                                id="lang"
                                                                value="{{ $view_job_skills_list->lang }}" readonly>
                                                        </div>
                                                        ...
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ $view_job_skills_list->job_skill }}"
                                                                readonly>
                                                        </div>
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <input type="is_default" class="form-control"
                                                                ...
                                                                value="{{ $view_job_skills_list->is_default === 1 ? 'default' : 'Un default' }}"
                                                                readonly>
                                                        </div>
                                                        ...
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <input type="is_active" class="form-control" id="is_active"
                                                                name="is_active"
                                                                value="{{ $view_job_skills_list->is_active === 1 ? 'Active' : 'In Active' }}"
                                                                readonly>
                                                        </div>
