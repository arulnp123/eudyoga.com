 ...
 <div class="page-wrapper">
     <div class="page-content">
         ...
         <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
             <div class="breadcrumb-title pe-3">Manage Result Types</div>
             <div class="ps-3">
                 <nav aria-label="breadcrumb">
                     <ol class="breadcrumb mb-0 p-0">
                         <li class="breadcrumb-item"><a href="javascript:;"></a>
                         </li>
                         <li class="breadcrumb-item active" aria-current="page">Result Types</li>
                     </ol>
                 </nav>
             </div>
         </div>
             ...
             <div class=" table-responsive">
                 <table id="example2" class="table table-striped table-bordered">
                     ...
                     <tbody>
                         ...
                         @foreach ($listresult as $key => $listresultlist)
                             <tr">

                                 <td class=""> {{ $listresultlist->lang }}</td>
                                 <td class=""> {{ $listresultlist->result_type }}</td>
                                 <td class="">
                                     ...
                                     <div class="col">
                                         ...
                                         <button type="button" class="btn btn-light"><a
                                                 href="{{ url('view_result_type', $listresultlist->id) }}"><i
                                                     class="lni lni-eye"></i>
                                         </button>
                                         <button type="button" class="btn btn-light"><a
                                                 href="{{ url('edit_result_type', $listresultlist->id) }}"><i
                                                     class='bx bx-edit me-0'></i>
                                         </button>
                                         <button type="button" class="btn btn-light"> <a
                                                 onclick="return confirm('Do you want to Confirm delete operation?')"
                                                 href="{{ url('/delete_result_type', $listresultlist->id) }}"><i
