            ...
            <div class="page-content">
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <form action="{{ url('save_language') }}" method="POST">
                        ...
                        <div class="input-group mb-3 p-2">
                            <select name="lang" id="lang" required class="form-control form-select"
                                ...
                                @foreach ($add_language as $key => $languageslist)
                                    <option value="{{ $languageslist->lang }}">
                                        {{ $languageslist->lang }}</option>
                                @endforeach
                        ...
                        <div class="input-group mb-3 p-2">
                            <select name="native" id="native" required class="form-control form-select"
                                aria-label="Default select example">
                                <option value=""> Native </option>
                                @foreach ($add_language as $key => $languageslist)
                                    <option value="{{ $languageslist->native }}">
                                        {{ $languageslist->native }}</option>
                                @endforeach
                        ...
                        <div>
                            <p class="h6 ps-3">ISO Code</p>
                        </div>

                        <div class="input-group mb-3 p-2">
                            <select name="iso_code" id="iso_code" required class="form-control form-select"
                                aria-label="Default select example">
                                <option value=""> ISO Code </option>
                                @foreach ($add_language as $key => $languageslist)
                                    <option value="{{ $languageslist->iso_code }}">
                                        {{ $languageslist->iso_code }}</option>
                                @endforeach
						...
						<div class="pt-3	">
                            <div>
                                <p class="h6 ps-3">Is RTL ?</p>
                            </div>

                            <div class=" d-flex ">
                                <div class="form-check ms-4 ">
                                    <input class="form-check-input" type="radio" name="is_rtl" id="is_rtl1"
                                        value="1" checked>
                                ...
                                <div class="form-check ms-3">
                                    <input class="form-check-input " type="radio" name="is_rtl" id="is_rtl2"
                                        value="0">
