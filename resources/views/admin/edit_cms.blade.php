        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <form action="{{ url('update_cms') }}" method="POST">
                        @csrf
                        @foreach ($get_cms as $key => $get_cms_list)
                            <input type="hidden"name="id" id="id" value="{{$get_cms_list->id}}">
                                ...
                                <select name="page_slug" id="page_slug" required class="form-control form-select"
                                    ...
                                    @foreach ($get_cms_detail as $key => $get_cms_detail_list)
                                        <option @if ($get_cms_detail_list->page_slug == $get_cms_list->page_slug) selected @endif
                                            ...
                                            {{ $get_cms_detail_list->page_slug }}</option>
                                    @endforeach
                            ...
                            <div class="pt-1">
                                ...
                                <div class=" d-flex ">
                                    ...
                                    <div class="form-check ms-4 ">
                                        <label class="form-check-label " name="show_in_top_menu" id="show_in_top_menu">
                                            <input type="radio" @if ($get_cms_list->show_in_top_menu == 1) checked @endif
                                                name="show_in_top_menu" id="show_in_top_menu" value="1">
                                            yes
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-check ms-3 ">
                                        <label class="form-check-label " name="show_in_top_menu" id="show_in_top_menu">
                                            <input type="radio" @if ($get_cms_list->show_in_top_menu == 0) checked @endif
                                                name="show_in_top_menu" id="show_in_top_menu" value="0">
                                            no
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="pt-3	">
                                ...
                                <div class=" d-flex ">
                                    ...
                                    <div class="form-check ms-3 ">
                                        <label class="form-check-label " name="show_in_footer_menu"
                                            id="show_in_footer_menu">
                                            <input type="radio" @if ($get_cms_list->show_in_footer_menu == 1) checked @endif
                                                name="show_in_footer_menu" id="show_in_footer_menu" value="1">
                                            no
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-check ms-3 ">
                                        <label class="form-check-label " name="show_in_footer_menu"
                                            id="show_in_footer_menu">
                                            <input type="radio" @if ($get_cms_list->show_in_footer_menu == 0) checked @endif
                                                name="show_in_footer_menu" id="show_in_footer_menu" value="0">
                                            no
                                        </label>
                                    </div>
                                </div>
