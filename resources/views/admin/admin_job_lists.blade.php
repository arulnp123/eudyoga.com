                ...
                <div class="widget-content">
                  <div class="table-outer">
                    <table class="default-table manage-job-table">
                      ...
                      <tbody>
                      @foreach($admin_job_lists as $job)
                        <tr>
                          <td>
                            <h6><a href="{{ url('job_detail', $job->id) }}">{{ $job->job_tittle }}</h6>
                          ...
                          <td>
                            <div class="option-box">
                              <ul class="option-list">
                                ...
                                <li><button data-text="View Aplication"><a href="{{ url('/admin_edit_job',$job->id) }}"><span class="la la-eye"></span></a></button></li>
