            ...
            <div class="page-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="{{ url('list_carrer_level') }}"> Career Level
                                    </a></li>
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <div class="card-body d-flex align-items-center ">
                        ...
                        <p class="card-text h4 ms-2">CAREER LEVEL FORM</p>
                    </div>
                    ...
                    <form action="{{ url('update_carrer_level') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{ $get_career_levels->id }}">
                        ...
                        <div class="input-group  p-2">
                            <select name="lang" id="lang" required class="form-control form-select"
                                ...
                                @foreach ($get_career as $key => $get_career_levels_list)
                                    <option @if ($get_career_levels->lang == $get_career_levels_list->lang) selected @endif
                                        value="{{ $get_career_levels_list->lang }}">
                                        {{ $get_career_levels_list->lang }}</option>
                                @endforeach
                        ...
                        <div class="input-group mb-3 p-2">
                            <select name="career_level" id="career_level" required class="form-control form-select"
                                aria-label="Default select example">
                                <option value="" selected>Select Career Level</option>
                                @foreach ($get_career as $key => $get_career_levels_list)
                                    <option @if ($get_career_levels->career_level == $get_career_levels_list->career_level) selected @endif
                        ...
                        <div class=" d-flex">
                            <div class="form-check ms-3 ">
                                <label class="form-check-label " for="is_default">
                                    <input type="radio" @if ($get_career_levels->is_default == 1) checked @endif
                            ...
                            <div class="form-check ms-3">
                                <label class="form-check-label" for="is_default">
                                    <input type="radio" @if ($get_career_levels->is_default == 0) checked @endif
                            ...
                            <div class=" d-flex ">
                                <div class="form-check ms-4 ">
                                    <label class="form-check-label " name="is_active" id="is_active1">
                                        <input type="radio" @if ($get_career_levels->is_active == 1) checked @endif
                                ...
                                <div class="form-check ms-3">
                                    ...
                                    <label class="form-check-label" for="is_active2">
                                        <input type="radio" @if ($get_career_levels->is_active == 0) checked @endif
