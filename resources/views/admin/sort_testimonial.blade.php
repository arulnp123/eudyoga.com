    ...
    <div class="page-content">
        ...
        <div class="card pb-5" style="width: 100%">
            ...
            <div class="card-body d-flex align-items-center ">
                ...
                <p class="card-text h5 ms-2">SORT TESTIMONIAL</p>
            </div>

            <ul class="nav nav-tabs">

                <li class="nav-item">
                    <a class="nav-link active ms-3 " aria-current="page" href="#">Short Testimonial</a>
                </li>

            </ul>

            <div>
                <p class="h4 m-2 mt-5 ps-2">Drag and Drop To Short Testimonial</p>
            </div>
            ...
            <ul class="list-group ">
                <li class="list-group-item"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    </svg> {{ $get_testimonial_list->testimonial}}</li>
