	  ...
	  <div class="card-body">
		...
		<div class="card pb-3" style="width: 100%">
			...
			<form action="{{ url('add_industries') }}" method="POST">
				...
				<div class="input-group mb-3 p-2">
					<select name="industry" id="industry" required class="form-control form-select"
						aria-label="Default select example">
						<option value=""> Select Industry </option>
						@foreach ($add_industries as $key => $add_industrieslist)
							<option value="{{ $add_industrieslist->industry }}">
								{{ $add_industrieslist->industry }}</option>
						@endforeach
				...
				<div class="input-group mb-3 p-2">
					<select name="lang" id="lang" required class="form-control form-select"
						...
						@foreach ($add_industries as $key => $add_industrieslist)
							<option value="{{ $add_industrieslist->lang }}">
								{{ $add_industrieslist->lang }}</option>
						@endforeach
