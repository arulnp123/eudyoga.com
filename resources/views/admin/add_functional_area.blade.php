        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <form action="{{ url('add_functional_areas') }}" method="POST">
                        @csrf
                        ...
                        <div class="input-group mb-3 p-2">
                            <select name="lang" id="lang" required class="form-control form-select"
                                ...
                                @foreach ($add_functional_area as $key => $add_functional_areaslist)
                                    <option value="{{ $add_functional_areaslist->lang }}">
                                        {{ $add_functional_areaslist->lang }}</option>
                                @endforeach
                        ...
                        <div class="input-group mb-3 p-2">
                            <select name="functional_area" id="functional_area" required class="form-control form-select"
                                aria-label="Default select example">
                                <option value="">Functional Area </option>
                                @foreach ($add_functional_area as $key => $add_functional_areaslist)
                                    <option value="{{ $add_functional_areaslist->functional_area }}">
                                        {{ $add_functional_areaslist->functional_area }}</option>
                                @endforeach
