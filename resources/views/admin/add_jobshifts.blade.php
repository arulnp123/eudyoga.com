                    ...
                    <form action="{{ url('add_jobsshifts') }}" method="POST">
                        ...
                        <div class="input-group mb-3 p-2">
                            <select name="job_shift" id="job_shift" required class="form-control form-select"
                                ...
                                <option value=""> Select Job Shifts </option>
                                @foreach ($job_shifts as $key => $job_shiftslist)
                                    <option value="{{ $job_shiftslist->job_shift }}">
                                        {{ $job_shiftslist->job_shift }}</option>
                                @endforeach
                        ...
                        <div class="input-group mb-3 p-2">
                            <select name="lang" id="lang" required class="form-control form-select"
                                ...
                                @foreach ($job_shifts as $key => $job_shiftslist)
                                    <option value="{{ $job_shiftslist->lang }}">
                                        {{ $job_shiftslist->lang }}</option>
                                @endforeach
