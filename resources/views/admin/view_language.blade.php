                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="bs-stepper-content">
                                                <form class="row g-3" action="#" enctype="multipart/form-data">
                                                    @csrf
                                                    @foreach ($view_language as $key => $edit)
                                                        <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane"
                                                            ...
                                                            <div class="row g-3">
                                                                ...
                                                                <div class="col-12 col-lg-6">
                                                                    <label for="native" class="form-label">Native</label>
                                                                    <input type="text" class="form-control"
                                                                        name="native" id="native "
                                                                        placeholder="native "
                                                                        value="{{ $edit->native }}" readonly>
                                                                </div>
                                                                <div class="col-12 col-lg-6">
                                                                    <label for="iso_code"
                                                                        class="form-label">ISO Code</label>
                                                                    <input type="text" class="form-control"
                                                                        name="iso_code" id="iso_code "
                                                                        placeholder="iso_code " value="{{ $edit->iso_code }}"
                                                                        readonly>
                                                                </div>
                                                                <div class="col-12 col-lg-6">
                                                                    <label for="is_rtl"
                                                                        class="form-label">Is RTL </label>
                                                                    <input type="text" class="form-control"
                                                                        name="is_rtl" id="is_rtl "
                                                                        placeholder="is_rtl " value="{{ $edit->is_rtl }}"
                                                                        readonly>
                                                                </div>
                                                                <div class="col-12 col-lg-6">
                                                                    <label for="is_default"
                                                                        class="form-label">Is Default </label>
                                                                    <input type="text" class="form-control"
