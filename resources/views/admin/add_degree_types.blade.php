            ...
            <div class="page-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="{{ url('list_degree_types') }}"> Degree Types
                                    </a></li>
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <div class="card-body d-flex align-items-center ">
                        ...
                        <p class="card-text h4 ms-2">DEGREE TYPE FORM</p>
                    </div>
                    ...
                    <form action="{{ url('save_degree_types') }}" method="POST">
                        @csrf
                        ...
                        <div class=" ps-4 pt-4">
                            <p class="h6">Degree Level</p>
                        </div>

                        <select name="degree_level" id="degree_level" required class="form-control form-select mt-3">
                            <option value="">Select Degree Level</option>

                            @foreach ($get_degree_levels as $key => $get_degree_levels_list)
                                <option value="{{ $get_degree_levels_list->degree_level}}">
                                    {{ $get_degree_levels_list->degree_level }}</option>
                            @endforeach
                        </select>

                        <div class=" ps-4 pt-4">
                            <p class="h6">Degree Type</p>
                        </div>

                        <div class="input-group mb-3 p-2">
                            <select name="degree_type" id="degree_type" required class="form-control form-select"
                                aria-label="Default select example">
                                <option value="" selected>Degree Type</option>
                                @foreach ($get_degree_types as $key => $get_degree_types_list)
                                    <option value="{{ $get_degree_types_list->degree_type}}">
