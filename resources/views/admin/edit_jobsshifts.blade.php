        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <form action="{{ url('update_jobsshifts') }}" method="POST">
                        <input value="{{ $edit_jobsshifts->id }}" type="hidden" name="job_id" />
                        @csrf
                        <div>
                        ...
                        <div class="input-group mb-3 p-2">
                            <select name="job_shift" id="job_shift" required
                                ...
                                @foreach ($get_jobsshifts as $job_shifts_list)
                                <option @if ($edit_jobsshifts->job_shift == $job_shifts_list->id) selected @endif
                        ...
                        <div class="input-group mb-3 p-2">
                                    ...
                                    <select name="lang" id="lang" required
                                        ...
                                        @foreach ($get_jobsshifts as $job_shifts_list)
                                        <option @if ($edit_jobsshifts->lang == $job_shifts_list->id) selected @endif
                                            value="{{ $job_shifts_list->lang }}">
                                            {{ $job_shifts_list->lang }}
                                        </option>
                                    @endforeach
                                    </select>
                        ...
                        <div class=" d-flex">
                            <div class="form-check ms-3 ">
                                    <label class="form-check-label " for="is_default">
                                        <input type="radio" @if ($edit_jobsshifts->is_default == 1) checked @endif
                            ...
                            <div class="form-check ms-3">
                                <label class="form-check-label" for="is_default">
                                    <input type="radio" @if ($edit_jobsshifts->is_default == 0) checked @endif
                            ...
                            <div class=" d-flex ">
                                <div class="form-check ms-4 ">
                                    <label class="form-check-label " name="is_active" id="is_active1">
                                        <input type="radio" @if ($edit_jobsshifts->is_active == 1) checked @endif
                                            name="is_active" id="is_active1" value="1">
                                        Active
                                    </label>
                                </div>
                                <div class="form-check ms-3">
                                    <input type="radio" @if ($edit_jobsshifts->is_active == 0) checked @endif
                        ...
                        <div class="ms-3 mt-4">
                            <button name="submit" type="submit" id="save"class="btn btn-secondary">
                                Update
