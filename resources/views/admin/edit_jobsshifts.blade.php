            ...
            <div class="page-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="{{ url('list_jobshifts') }}">Job Shifts
                                    </a></li>
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <div class="card-body d-flex align-items-center ">
                        ...
                        <p class="card-text h4 ms-2">JOB SHIFTS FORM</p>
                    </div>
                    ...
                    <form action="{{ url('update_jobsshifts') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @foreach ($edit_jobsshifts as $job_shifts)
                            <div class="ps-4 pt-4">
                                <p class="h6">Id</p>
                            </div>
                            ...
                            <div class="input-group  p-2">
                                ...
                                <select name="lang" id="lang" required class="form-control form-select"
                                    ...
                                    @foreach ($get_jobsshifts as $key => $get_jobsshifts_list)
                                        <option @if ($get_jobsshifts_list->job_shift_id == $job_shifts->lang) selected @endif
                                            value="{{ $get_jobsshifts_list->lang }}">
                                            {{ $get_jobsshifts_list->lang }}</option>
                                    @endforeach
                            ...
                            <div>
                                <p class="h6 mt-3 ps-3">job Shift</p>
                            </div>
                            ...
                            <div class="input-group  p-2">
                                ...
                                <select name="job_shift" id="job_shift" required class="form-control form-select"
                                    ...
                                    @foreach ($get_jobsshifts as $key => $get_jobsshifts_list)
                                        <option @if ($get_jobsshifts_list->job_shift_id == $job_shifts->job_shift) selected @endif
                                            value="{{ $get_jobsshifts_list->job_shift }}">
                                            {{ $get_jobsshifts_list->job_shift }}</option>
                                    @endforeach
                            ...
                            <div class=" d-flex">
                                <div class="form-check ms-3 ">
                                    <label class="form-check-label " for="is_default">
                                        <input type="radio" @if ($job_shifts->is_default == 1) checked @endif
                                ...
                                <div class="form-check ms-3">
                                    <label class="form-check-label" for="is_default">
                                        <input type="radio" @if ($job_shifts->is_default == 0) checked @endif
                                ...
                                <div class=" d-flex ">
                                    <d6iv class="form-check ms-4 ">
                                        <label class="form-check-label " name="is_active" id="is_active1">
                                            <input type="radio" @if ($job_shifts->is_active == 1) checked @endif
                                    ...
                                    <div class="form-check ms-3">
                                        ...
                                        <label class="form-check-label" for="is_active2">
                                            <input type="radio" @if ($job_shifts->is_active == 0) checked @endif
