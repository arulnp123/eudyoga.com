            ...
            <div class="page-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="{{ url('list_job_experiance') }}"> Job Experiance
                                    </a></li>
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <div class="card-body d-flex align-items-center ">
                        ...
                        <p class="card-text h4 ms-2">JOB EXPERIANCE FORM</p>
                    </div>
                    ...
                    <form action="{{ url('save_job_experiance') }}" method="POST">
                        @csrf
                        ...
                        <div class=" ps-4 pt-4">
                            <p class="h6">Job Experiance</p>
                        </div>

                        <select name="job_experience" id="job_experience" required
                            class="form-control form-select mt-3">
                            <option value="">Select Job Experiance</option>

                            @foreach ($add_job_experiance as $key => $add_job_experiance_list)
                                <option value="{{ $add_job_experiance_list->job_experience }}">
                                    {{ $add_job_experiance_list->job_experience }}</option>
                            @endforeach
                        </select>
