                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Result Type</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="bs-stepper-content">
                                        ...
                                        <form action="#" enctype="multipart/form-data">
                                            @csrf
                                            @foreach ($view_result_type as $key => $view_result_type_list)
                                                <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane"
                                                    aria-labelledby="stepper2trigger1">
                                                    <h5 class="mb-1">Result Type</h5>
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <input type="text" class="form-control" name="lang"
                                                                id="lang"
                                                                value="{{ $view_result_type_list->lang }}" readonly>
                                                        </div>
                                                        
                                                        <div class="col-12 col-lg-6">
                                                            <label for="degree_type" class="form-label">Result Type</label>
                                                            <input type="text" class="form-control"
                                                                name="result_type" id="result_type"
                                                                value="{{ $view_result_type_list->result_type }}"
                                                                readonly>
                                                        </div>
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <input type="is_default" class="form-control"
                                                                ...
                                                                value="{{ $view_result_type_list->is_default === 1 ? 'default' : 'Un default' }}"
                                                                readonly>
                                                        </div>
                                                        ...
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <input type="is_active" class="form-control" id="is_active"
                                                                name="is_active"
                                                                value="{{ $view_result_type_list->is_active === 1 ? 'Active' : 'In Active' }}"
                                                                readonly>
                                                        </div>
