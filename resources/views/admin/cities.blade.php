...
<div class="page-wrapper">
   <div class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
         <div class="breadcrumb-title pe-3">Cities Details</div>
         ...
         @endif 
         <div class="ms-auto">
            <button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#city">Add</button>
         </div>
      </div>
      <div class="card">
         <div class="card-body">
                     ...
                     <tr>
					    ...
					    <td>
						  <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#Editcity{{ $citylist->id }}">Edit</button>
                              ...
                              <a type="button" onclick="return confirm('Do you want to perform delete operation?')" href="{{ url('/deletecity' , $citylist->id) }}" class="btn btn-info"> Delete</a>
