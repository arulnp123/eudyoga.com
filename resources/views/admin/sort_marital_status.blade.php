    ...
    <div class="page-content">
        ...
        <div class="card pb-5" style="width: 100%">
            ...
            <div class="card-body d-flex align-items-center ">
                ...
                <p class="card-text h5 ms-2">SORT MARITAL STATUS</p>
            </div>

            <ul class="nav nav-tabs">

                <li class="nav-item">
                    <a class="nav-link active ms-3 " aria-current="page" href="#">Short Marital Status</a>
                </li>
            ...
            @foreach($sort_marital_status as $key=>$sort_marital_status_list)
            ...
            <ul class="list-group ">
                <li class="list-group-item"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    </svg> {{ $sort_marital_status_list->marital_status}}</li>
