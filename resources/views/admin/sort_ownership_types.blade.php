    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ url('list_result_types') }}">
                                Result Types
                            </a></li>
        ...
        <div class="card pb-5" style="width: 100%">
            ...
            <div class="card-body d-flex align-items-center ">
                ...
                <p class="card-text h5 ms-2">SORT RESULT TYPES</p>
            </div>

            <ul class="nav nav-tabs">

                <li class="nav-item">
                    <a class="nav-link active ms-3 " aria-current="page" href="#">Short Result Type</a>
                </li>
            ...
            @foreach($ownershiptype as $key=>$ownershiptypelist)
            ...
            <ul class="list-group ">
                <li class="list-group-item"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    </svg> {{ $ownershiptypelist->ownership_type}}</li>
