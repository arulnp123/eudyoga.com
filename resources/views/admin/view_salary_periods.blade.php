                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Major Subeject</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="bs-stepper-content">
                                        ...
                                        <form action="#" enctype="multipart/form-data">
                                            @csrf
                                            @foreach ($view_salary_periods as $key => $view_salary_periods_list)
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <input type="text" class="form-control" name="lang"
                                                                id="lang"
                                                                value="{{ $view_salary_periods_list->lang }}" readonly>
                                                        </div>
                                                        <div class="col-12 col-lg-6">
                                                            <label for="Salary_period" class="form-label">Salary Period</label>
                                                            <input type="text" class="form-control"
                                                                name="Salary_period" id="Salary_period"
                                                                value="{{ $view_salary_periods_list->salary_period }}"
                                                                readonly>
                                                        </div>
                                                        ...
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <input type="is_default" class="form-control"
                                                                ...
                                                                value="{{ $view_salary_periods_list->is_default === 1 ? 'default' : 'Un default' }}"
                                                                readonly>
                                                        </div>
                                                        ...
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <input type="is_active" class="form-control" id="is_active"
                                                                name="is_active"
                                                                value="{{ $view_salary_periods_list->is_active === 1 ? 'Active' : 'In Active' }}"
                                                                readonly>
                                                        </div>
