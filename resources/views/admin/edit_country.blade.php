            ...
            <div class="page-content">
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <div class="card-body d-flex align-items-center ">
                        ...
                        <p class="card-text h4 ms-2">COUNTRY FORM</p>
                    </div>
                    ...
                    <form action="{{ url('update_country') }}" method="POST">
						...
						<div class="input-group mb-2 p-2">
                        <select name="country" id="country" required class="form-control form-select mt-3">
                            <option value="">Country</option>

                            @foreach ($get_country_list as $key => $get_country_list)
                                <option value="{{ $get_country_list->country}}">
                                    {{ $get_country_list->country }}</option>
                            @endforeach
                        </select>
						</div>
                        ...
                        <div class="input-group mb-2 p-2">
                            <select name="nationality" id="nationality" required class="form-control form-select"
                                aria-label="Default select example">
                                <option value="">Nationality</option>
                                @foreach ($get_nationality_list as $key => $get_nationality_list)
                                    <option value="{{ $get_nationality_list->nationality}}">
                                        {{ $get_nationality_list->nationality}}</option>
                                @endforeach
