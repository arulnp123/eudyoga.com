            ...
            <div class="page-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="{{ url('list_major_subjects') }}">Major Subject
                                    </a></li>
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <div class="card-body d-flex align-items-center ">
                        ...
                        <p class="card-text h4 ms-2">MAJOR SUBJECT FORM</p>
                    </div>
                    ...
                    <form action="{{ url('update_major_subject') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @foreach ($edit_major_subject as $edit)
                            ...
                            <div class="input-group mb-3 p-2">
                                <select name="salary_period" id="salary_period" required
                                    ...
                                    @foreach ($get_major_subject as $key => $get_major_subject_list)
                                        <option @if ($get_major_subject_list->major_subject == $edit->major_subject) selected @endif
                                            value="{{ $get_major_subject_list->major_subject }}">
                                            {{ $get_major_subject_list->major_subject }}</option>
                                    @endforeach
