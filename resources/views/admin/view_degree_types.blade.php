                                ...
                                <div class="card-body">
                                    ...
                                    <div class="bs-stepper-content">
                                        ...
                                        <form action="#" enctype="multipart/form-data">
                                            @csrf
                                            @foreach ($view_degree_type as $key => $view_degree_type_list)
                                                       ...
                                                       <!-- <div class="col-12 col-lg-6">
                                                        ...
                                                        <div class="col-12 col-lg-6">
                                                            <label for="degree_type" class="form-label">Degree
                                                                Type</label>
                                                            <input type="text" class="form-control"
                                                                name="degree_type" id="degree_type"
                                                                value="{{ $view_degree_type_list->degree_type }}"
                                                                readonly>
                                                        </div>
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <input type="is_default" class="form-control"
                                                                ...
                                                                value="{{ $view_degree_type_list->is_default === 1 ? 'default' : 'Un default' }}"
                                                                readonly>
                                                        </div>
                                                        ...
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <input type="is_active" class="form-control" id="is_active"
                                                                name="is_active"
                                                                value="{{ $view_degree_type_list->is_active === 1 ? 'Active' : 'In Active' }}"
                                                                readonly>
                                                        </div>
