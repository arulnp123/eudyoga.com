            ...
            <div class="page-content">
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <div class="card-body d-flex align-items-center ">
                        ...
                        <p class="card-text h4 ms-2">Job Experience FORM</p>
                    </div>
                    ...
                    <form action="{{ url('update_job_experiance') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="input-group  p-2">
                            ...
                            <select name="lang" id="lang" required class="form-control form-select"
                                ...
                                @foreach ($get_job_experience as $key => $get_job_experience_list)
                                    <option @if ($get_job_experience_list->lang == $edit->lang) selected @endif
                                        value="{{ $get_job_experience_list->lang }}">
                                        {{ $get_job_experience_list->lang }}</option>
                                @endforeach
                        ...
                        <div class=" ps-4 pt-4">
                            <p class="h6">Select Job Experience</p>
                        </div>
                            ...
                            <select name="job_experience" id="job_experience" required class="form-control form-select" aria-label="Default select example">
                                ...
                                @foreach ($get_job_experience as $key => $get_job_experience_list)
                                    <option @if ($get_job_experience_list->job_experience == $edit->job_experience) selected @endif
                                        ...
                                        {{ $get_job_experience_list->job_experience }}</option>
                                @endforeach
