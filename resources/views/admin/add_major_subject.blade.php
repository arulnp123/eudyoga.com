        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <form action="{{url('save_major_subject')}}" method="POST">
                        @csrf
                        ...
                        <div class=" ps-4 pt-4">
                            <p class="h6"> Select Major Subject</p>
                        </div>

                        <div class="input-group mb-3 p-2">
                            <select name="major_subject" id="major_subject" required class="form-control form-select"
                            aria-label="Default select example">
                            <option value="" selected>Major Subject</option>
                            @foreach ($add_major_subject as $key => $add_major_subject_list)
                                <option value="{{ $add_major_subject_list->major_subject_id }}">
                                    {{ $add_major_subject_list->major_subject}}</option>
                            @endforeach
