    ...
    <div class="page-content">
        ...
        <div class="card pb-5" style="width: 100%">
            ...
            <div class="card-body d-flex align-items-center ">
                ...
                <p class="card-text h5 ms-2">SORT JOB SKILL</p>
            </div>

            <ul class="nav nav-tabs">

                <li class="nav-item">
                    <a class="nav-link active ms-3 " aria-current="page" href="#">Short Job Skill</a>
                </li>

            </ul>

            <div>
                <p class="h4 m-2 mt-5 ps-2">Drag and Drop to Short Job Skill</p>
            </div>
            ...
            @foreach($sort_job_skills as $key=>$sort_job_skills_list)
            ...
            <ul class="list-group ">
                <li class="list-group-item"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    </svg> {{ $sort_job_skills_list->job_skill}}</li>
