            ...
            <div class="page-content">
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <div class="card-body d-flex align-items-center ">
                        ...
                        <p class="card-text h4 ms-2">LANGUAGES FORM</p>
                    </div>
                    ...
                    <form action="{{ url('update_language') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @foreach ($edit_language as $language)
