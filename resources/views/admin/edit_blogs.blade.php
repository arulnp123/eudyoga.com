                                            ...
                                            <form class="row g-3" method="post" action="{{ url('/update_blogs') }}"
                                                ...
                                                <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane"
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <input type="text" class="form-control" name="heading"
                                                            id="heading" placeholder="Heading" value="{{ $edit_blogs->heading }}"> 
                                                        </div>
                                                        <div class="col-12 col-lg-6">
                                                            <label for="slug" class="form-label">Slug</label>
                                                            <input type="text" class="form-control" name="slug"
                                                                id="slug" placeholder="Slug" value="{{ $edit_blogs->slug }}">       
                                                        </div>
                                                        <div class="col-12 col-lg-6">
                                                            <label for="content" class="form-label">Content</label>
                                                        <textarea class="form-control" name="content" id="content" 
                                                          placeholder="Content" rows="3"> {{ $edit_blogs->content }} </textarea>                                                          
                                                        </div>
                                                        <div class="col-12 col-lg-6">
                                                            <label for="cate_id" class="form-label">Cate Id</label>
                                                            <input type="text" class="form-control" name="cate_id"
                                                                id="cate_id" placeholder="Cate Id" value="{{ $edit_blogs->cate_id }}">                                                               
                                                        </div>
                                                        <div class="col-12 col-lg-6">
                                                ...
                                                <div id="test-nl-2" role="tabpanel" class="bs-stepper-pane"
                                                    ...
                                                    <input type="text" class="form-control" name="image"
                                                     id="image" required class="form-control form-select" placeholder="image">
                                                       ...
                                                       <div class="col-12 col-lg-6">
                                                        ...
                                                        <input type="text" class="form-control number" name="featured" 
                                                            id="InputEmail2" placeholder="Featured" value="{{ $edit_blogs->featured }}">    
                                                        </div>
                                                        <div class="col-12 col-lg-6">
                                                            <label for="meta_title" class="form-label">Meta Title</label>
                                                        <input type="text" class="form-control" name="meta_title"
                                                            id="meta_title" placeholder="meta_title" value="{{ $edit_blogs->meta_title }}"> 
                                                           
                                                        </div>
                                                        <div class="col-12 col-lg-6">
                                                            <label for="lang" class="form-label">Lang</label>
                                                        <input type="text" class="form-control" name="lang"
                                                            id="lang" placeholder="Lang" value="{{ $edit_blogs->lang }}">
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <input type="text" class="form-control" name="meta_keywords"
                                                                id="meta_keywords" placeholder="Meta Keywords" value="{{ $edit_blogs->meta_keywords }}">
                                                        ...
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <input type="text" class="form-control" name="meta_descriptions"
                                                                id="meta_descriptions"  placeholder="Meta Descriptions" value="{{ $edit_blogs->meta_descriptions }}">
                                                        </div>
                                                        <div class="col-12 col-lg-6">
                                                            <label for="remember_token" class="form-label">Remember Token</label>
                                                            <input type="text" class="form-control" name="remember_token"
                                                                id="remember_token" placeholder="Remember Token" value="{{ $edit_blogs->remember_token }}">
                                                        </div>
                                                        <div class="col-12 col-lg-6">
                                                            <label for="created_at" class="form-label">Created At</label>
                                                        <input type="date" class="form-control"name="created_at"
                                                            id="created_at" placeholder="Created At" value="{{ $edit_blogs->created_at }}">
                                                        </div>
                                                        <div class="col-12 col-lg-6">
                                                            <label for="updated_at" class="form-label">Updated At</label>
                                                            <input type="date" class="form-control" name="updated_at"
                                                               id="updated_at" required class="form-control form-select" placeholder="Updated At" value="{{ $edit_blogs->updated_at }}">
