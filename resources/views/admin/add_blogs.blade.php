                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        ...
                                                        <textarea class="form-control" name="content" id="content" 
                                                         required class="form-control form-select" placeholder="Content" rows="3">
                                                        </textarea>   
                                                    </div>
                                                    <div class="col-12 col-lg-6">
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        <button class="btn btn-light px-4" type="button" onclick="stepper2.next()">
                                                            Next<i class='bx bx-right-arrow-alt ms-2'></i></button>
                                                    </div>
                                                </div><!---end row-->
                                            </div>
                                                   ...
                                                   <!--<div class="col-12 col-lg-6">
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        ...
                                                        <input type="text" class="form-control number" name="featured" 
                                                            id="InputEmail2" required class="form-control form-select" placeholder="Featured">
                                                    </div>                                                 
                                                    <div class="col-12 col-lg-6">
                                                        <label for="meta_title" class="form-label">Meta Title</label>
                                                        <input type="text" class="form-control" name="meta_title"
                                                            id="meta_title" required class="form-control form-select" placeholder="meta_title">
                                                    </div>                                                   
                                                    <div class="col-12 col-lg-6">
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        ...
                                                        <input type="date" class="form-control"name="created_at"
                                                            id="created_at" required class="form-control form-select" placeholder="Created At">
                                                    </div>
                                                    <div class="col-12 col-lg-6">
