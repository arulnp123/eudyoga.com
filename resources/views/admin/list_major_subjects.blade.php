...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Manage Major Subject</div>
            <div class="ps-3">
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title d-flex justify-content-between">
                        <div class=" caption"> <i class="icon-settings font-dark"></i> <span
                                class="caption-subject font-dark sbold uppercase">Major Subject</span> </div>
            ...
            <div class=" table-responsive">
                <table id="example2" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        @foreach ($listmajor as $key => $major_list)
                            <tr">

                                <td class=""> {{ $major_list->lang }}</td>
                                <td class=""> {{ $major_list->major_subject }}</td>
                                <td class="">
                                    ...
                                    <div class="col">
                                                ...
                                                <button type="button" class="btn btn-light"><a
                                                    href="{{ url('view_major_subject', $major_list->id) }}"><i
                                                        class="lni lni-eye"></i>
                                            </button>
                                                <button type="button" class="btn btn-light"><a
                                                        href="{{ url('edit_major_subject', $major_list->major_subject_id) }}"><i
