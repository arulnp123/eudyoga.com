        ...
        <div class="page-wrapper">
            <div class="page-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="{{ url('list_career_level') }}">Caree Level
                                    </a></li>
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <form action="{{ url('save_carrer_level') }}" method="POST">
                        @csrf
                        ...
                        <div class="input-group mb-3 p-2">
                            <select name="career_level" id="career_level" required class="form-control form-select"
                                ...
                                @foreach ($get_career_levels as $key => $get_career_levels_list)
                                    <option value="{{ $get_career_levels_list->career_level }}">
