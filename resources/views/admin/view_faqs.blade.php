                                                    ...
                                                    @foreach ($view_faqs as $key => $edit)
                                                        <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane"
                                                            ...
                                                            <div class="row g-3">
                                                                ...
                                                                <div class="col-12 col-lg-6">
                                                                    <label for="faq_question" class="form-label">Slider </label>
                                                                    <input type="text" class="form-control"
                                                                        name="faq_question" id="faq_question "
                                                                        placeholder="faq_question "
                                                                        value="{{ $edit->faq_question }}" readonly>
                                                                </div>
                                                                <div class="col-12 col-lg-6">
                                                                    <label for="faq_answer" class="form-label">Slider </label>
                                                                    <input type="text" class="form-control"
                                                                        name="faq_answer" id="faq_answer "
