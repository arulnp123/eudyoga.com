...
<div class="bs-stepper-content">
        ...
        @foreach ($view_country_details as $key => $edit)
                                                    ...
                                                    <div class="row g-3">
                                                                ...
                                                                <div class="col-12 col-lg-6">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="{{ $edit->thousand_separator }}" readonly>
                                                                </div>    
                                                                <div class="col-12">
                                                ...
                                                <div id="test-nl-3" role="tabpanel" class="bs-stepper-pane"
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="{{ $edit->decimal_separator }}" readonly>
                                                                </div>    
