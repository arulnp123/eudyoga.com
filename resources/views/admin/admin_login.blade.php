...
<head>
  ...
  <!--favicon-->
  <link rel="icon" href="{{ URL::to('/') }}/assets1/images/favicon-32x32.png" type="image/png" />
  <!--plugins-->
      ...
      <div class="">
        <div class="row g-0">
          ...
          <div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex">
              ...
              <div class="card-body">
                                 <img src="{{ URL::to('/') }}/assets1/images/login-images/login-cover.svg" class="img-fluid auth-img-cover-login" width="650" alt=""/>
              </div>
            </div>
              ...
              <div class="card-body p-sm-5">
                <div class="">
                  <div class="mb-3 text-center">
                    <img src="{{ URL::to('/') }}/assets1/images/logo-icon.png" width="60" alt="">
                  </div>
                  <div class="text-center mb-4">
                    <h5 class="">Eudyoga Admin</h5>
                  ...
                  <div class="form-body">
                      ...
                      <div class="col-12">
                        ...
                        <div class="input-group">
                          <input type="password" class="form-control border-end-0" value="" name="password" placeholder="Enter Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class="bx bx-hide"></i></a>
                        </div>
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6 text-end"> <a href="{{ url('forgotpassword') }}">Forgot Password?</a>
                      </div>
                      <div class="col-12">
                        <div class="d-grid">
                      ...
                      <div class="col-12">
                        <div class="text-center">
                          <!--<p class="mb-0">Don't have an account yet?<a href="{{ url('admin_register') }}">Sign up here</a>-->
                          </p>
                        </div>
                      </div>
                    </form>
