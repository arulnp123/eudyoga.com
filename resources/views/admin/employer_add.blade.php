			...
			<div id="test-nl-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger1">
			  ...
			  <div class="row g-3">
				  ...
				  <div class="col-12 col-lg-6">
					  ...
					  <select name="password" id="PhoneNumber" required
					  class="form-control form-select"
					  aria-label="Default select example">
					  <option value="" selected>Password </option>
					  @foreach ($password as $key => $passwordlist)
						  <option value="{{ $passwordlist->id }}">
							  {{ $passwordlist->password }}</option>
					  @endforeach
				  ...
				  <div class="col-12 col-lg-6">
					  ...
					  class="form-control form-select"
					  aria-label="Default select example">
					  <option value="" selected>HR Recruiter Name </option>
				  ...
				  <div class="col-12 col-lg-6">
					  ...
					  <select name="ownership_type_id" id="InputEmail2" required
                                                            ...
                                                            @foreach ($ownership_type_id as $key => $ownership_type_idlist)
                                                                <option value="{{ $companieslist->id }}">
                                                                    {{ $ownership_type_idlist->ownership_type_id }}</option>
                                                            @endforeach
			...
			<div id="test-nl-3" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger3">
			  ...
			  <div class="row g-3">
				  ...
				  <div class="col-12 col-lg-6">
					  ...
					  class="form-control form-select"
					  aria-label="Default select example">
					  <option value="" selected>Number of offices </option>
					...
					<select name="name" id="name" required
                                                            ...
                                                            @foreach ($no_of_employees as $key => $no_of_employeeslist)
                                                                <option value="{{ $no_of_employeeslist->id }}">
                                                                    {{ $no_of_employeeslist->no_of_employees }}</option>
                                                            @endforeach
			...
			<div id="test-nl-4" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger4">
			  ...
			  <div class="row g-3">
				...
				<div class="col-12 col-lg-6">
					...
					<select name="package_start_date" id="package_start_date" required
                                                            class="form-control form-select"
                                                            aria-label="Default select example">
                                                            <option value="" selected>Package Start Date</option>
                                                            @foreach ($package_start_date as $key => $package_start_datelist)
                                                                <option value="{{ $package_start_datelist->id }}">
                                                                    {{ $package_start_datelist->package_start_date }}</option>
                                                            @endforeach
					...
					<select name="package_end_date" id="PhoneNumber" required
                                                            ...
                                                            @foreach ($package_end_date as $key => $package_end_datelist)
                                                                <option value="{{ $package_end_datelist->id }}">
                                                                    {{ $package_end_datelist->package_end_date }}</option>
                                                            @endforeach
