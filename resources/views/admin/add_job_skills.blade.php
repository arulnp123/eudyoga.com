        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="card pb-3" style="width: 100%">
                    ...
                    <form action="{{ url('save_job_skills') }}" method="POST">
                        @csrf
                        ...
                        <div class="input-group mb-3 p-2">
                            <select name="job_skill" id="job_skill" required class="form-control form-select"
                                ...
                                @foreach ($add_job_skills as $key => $save_job_skills_list)
                                    <option value="{{ $save_job_skills_list->job_skill }}">
                                        {{ $save_job_skills_list->job_skill }}</option>
                                @endforeach
