		 ...
		 <img src="../admin_assets/no-cover.jpg"  alt="krishnamurthy" title="krishnamurthy">
			...
			<div class="userMaininfo">
					...
					<div class="title">
						...
						<div class="desi"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-building" viewBox="0 0 16 16">
                ...
                <div class="job-header">
                    <div class="contentbox">
                        ...
                        <li class="row">
                            ...
                            <div class="col-md-6 col-xs-6 "><p class="h-6">{{$profile1->description}}</p></div>
                        </li>           
...
<a href="https://www.youtube.com/" target="_blank"><i class="fab fa-youtube-square" aria-hidden="true"></i></a>
  ...
  <div class="copyright">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="bttxt">Copyright &copy; 2023 E-Udyoga. All Rights Reserved. Design by: <a href="https://npgroups.com/" target="_blank">npgroups</a></div>
            </div>
            <!--<div class="col-md-4">-->
