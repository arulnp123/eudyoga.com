                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    ...
                    <ul class="boxes">
                        ...
                        <li class="order paypal"><a href="javascript:void(0)" data-bs-toggle="modal"
                                data-bs-target="#buypack7" class="reqbtn">Buy Now</a></li>
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <div class="invitereval">
                                        ...
                                        <ul class="btn2s">
                                            <li class="order payu"><a
                                                    href="https://eudyoga.com/payu-order-package?package_id=7&amp;type=upgrade">PayU</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="bttxt">Copyright &copy; 2024 E-Udyoga. All Rights Reserved. Design by: <a
                        href="www.npgroups.com" target="_blank">npgroups</a></div>
            </div>
            <!--<div class="col-md-4">-->
