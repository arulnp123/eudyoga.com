...
<div class="listpgWraper">
    ...
    <ul class="usernavdash">
        <li class="active"><a href="{{ url('/employer_index') }}"><i class="fas fa-tachometer" aria-hidden="true"></i> Dashboard</a></li>
        <li class=""><a href="{{ url('/basic_detials') }}"><i class="fa fa-user" aria-hidden="true"></i> Basic Details</a></li>
        ...
        <li class="nav-item"><a href="{{ url('/candiate_profile') }}"><i class="fa fa-users" aria-hidden="true"></i>Candidate Profile</a> </li>
        ...
        <li><a href="{{ route('employerlogout') }}"><i class="fas fa-sign-out" aria-hidden="true"></i> Logout</a>
