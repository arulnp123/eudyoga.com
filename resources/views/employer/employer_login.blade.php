                         ...
                         <div id="employer" >
                             <form class="form-horizontal" method="post" action="{{ url('/checklogin') }}">
                                 ...
                                 <div class="formpanel">
                                     ...
                                     <div class="mb-3"><i class="fas fa-lock" aria-hidden="true"></i> Forgot Your Password? <a href="https://eudyoga.com/company/password/reset">Click here</a></div>          
                                     <input type="submit" class="btn" value="Login">
                                 </div>
                                 <!-- login form  end--> 
                             </form>
                             <!-- sign up form -->
                             <div class="newuser"><i class="fas fa-user" aria-hidden="true"></i> New User? <a href="{{url('employer_register')}}">Register Here</a></div>
        ...
        <div class="row"> 
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul class="quicklinks">
                    ...
                    <li><a href="https://eudyoga.com/jobs?functional_area_id%5B%5D=17">Client Services &amp; Customer Support</a></li>
                </ul>
            </div>
