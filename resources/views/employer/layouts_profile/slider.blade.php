...
<div class="pageTitle">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="breadCrumb"><a href="https://eudyoga.com">Home</a> / <span>Company Profile</span></div>
            </div>
        </div>
    </div>
</div> 
...
<div class="listpgWraper">
    ...
    <ul class="usernavdash">
        ...
        <li><a href="{{url('/')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fas fa-sign-out" aria-hidden="true"></i> Logout</a>
