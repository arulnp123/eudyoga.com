    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <h1 class="page-heading">Candidate Profile</h1>
            </div>
            <div class="col-md-6 col-sm-6">
                <div class="breadCrumb"><a href="http://localhost/eudyoga.in/index">Home</a> / <span>Candidate Profile</span></div>
            </div>
        </div>
    </div>
</div> 
...
<div class="listpgWraper">
    <div class="container">  
		...
		<div class="usercoverimg">
		 ...
		 <img src="https://eudyoga.com/public//admin_assets/no-cover.jpg"  alt="krishnamurthy" title="krishnamurthy">
		
			
			<div class="userMaininfo">
                
						<div class="userPic"><img src="https://eudyoga.com/public//admin_assets/no-image.png"  alt="krishnamurthy" title="krishnamurthy"></div>
					
					<div class="title">
                                <h3>{{ $profile1->name  }}
                                                                <span>Immediate Available For Work</span>
                                								</h3>
						<div class="desi"><i class="fa fa-map-marker" aria-hidden="true"></i>{{$profile1->state}},{{$profile1->city}}</div>
        ...
        <div class="row">
         ...
         @foreach($profile as $pro)
                            ...
                            <li class="row">
                                ...
                                <div class="col-md-6 col-xs-6"><span>{{$pro->is_immediate_available	}}</span></div>
                            </li>

                            <li class="row">
                                <div class="col-md-6 col-xs-6">Age</div>
                                <div class="col-md-6 col-xs-6"><span> {{$pro->age}}</span></div>
                            </li>
                            <li class="row">
                                <div class="col-md-6 col-xs-6">Gender</div>
                                <div class="col-md-6 col-xs-6"><span>{{$pro->gender_id}}</span></div>
                            </li>
                            <li class="row">
                                <div class="col-md-6 col-xs-6">Marital Status</div>
                                <div class="col-md-6 col-xs-6"><span>{{$pro->marital_status_id}}</span></div>
                            </li>
                            <li class="row">
                                <div class="col-md-6 col-xs-6">Experience</div>
                                <div class="col-md-6 col-xs-6"><span>{{$pro->job_experience_id}}</span></div>
                            </li>
                            <li class="row">
                                <div class="col-md-6 col-xs-6">Career Level</div>
                                <div class="col-md-6 col-xs-6"><span>{{$pro->career_level_id}}</span></div>
                            </li>             
                            <li class="row">
                                <div class="col-md-6 col-xs-6">Current Salary</div>
                                <div class="col-md-6 col-xs-6"><span>{{$pro->current_salary}}</span></div>
                            </li>
                            <li class="row">
                                <div class="col-md-6 col-xs-6">Expected Salary</div>
                                <div class="col-md-6 col-xs-6"><span>{{$pro->expected_salary}}</span></div>
                            </li>              
                        </ul>
                        @endforeach
                    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <form action="" id="send-form">
                <input type="hidden" name="_token" value="R1qYQw2N5htyX5APvAkCtz2coVtt316fpjdugwD3">                <input type="hidden" name="seeker_id" id="seeker_id" value="638">
...
<div class="footerWrap"> 
  ...
  <div class="copyright">
  ...
  </div><script src="../cdnjs.cloudflare.com/ajax/libs/turbolinks/5.0.0/turbolinks.min.js" data-turbolinks-eval="false" data-turbo-eval="false"></script>
    ...
    <script src="{{ URL::to('/') }}/assets/admin_assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js" type="text/javascript"></script>
  
    <script src="{{ URL::to('/') }}/assets/admin_assets/global/plugins/Bootstrap-3-Typeahead/bootstrap3-typeahead.min.js" type="text/javascript"></script>
  
    <!-- END PAGE LEVEL PLUGINS -->
  
    <script src="{{ URL::to('/') }}/assets/admin_assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
  
    <script src="{{ URL::to('/') }}/assets/admin_assets/global/plugins/jquery.scrollTo.min.js" type="text/javascript"></script>
  
    <!-- Revolution Slider -->
  
    <script type="text/javascript" src="{{ URL::to('/') }}/assets/js/revolution-slider/js/jquery.themepunch.tools.min.js"></script>
  
    <script type="text/javascript" src="{{ URL::to('/') }}/assets/js/revolution-slider/js/jquery.themepunch.revolution.min.js"></script>
  ...
  <script type="text/javascript">
    ...
    if (country_id != ''){
    $.post("filter-states-dropdown.html", {country_id: country_id, state_id: state_id, _method: 'POST', _token: 'wf92gEzv5MvhnWl0HXPEaDnWDxKuc9Q5hOMnPnR8'})
    ...
    if (state_id != ''){
    $.post("filter-cities-dropdown.html", {state_id: state_id, city_id: city_id, _method: 'POST', _token: 'wf92gEzv5MvhnWl0HXPEaDnWDxKuc9Q5hOMnPnR8'})
            .done(function (response) {
