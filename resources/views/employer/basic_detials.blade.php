                ...
                <div class="row">
                   <div class="col-md-12">
                         <div class="col-md-12 col-sm-12" >
                            ...
                            <br>
                            <br>
                            <center><h3>Basic Details</h3></center>
                        ...
                        <div class="card">
                          ...
                          <div class="card-header">
                            ...
                            <div class="bs-stepper-content">
                             <form  method="get" action="{{url('/basicdetialscandidate')}}" enctype="multipart/form-data">
                                 @csrf
                                 <input type="hidden" class="form-control" value="{{ $employerprofile->id }}" name="id">
                                <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger1">
                                  <h5 class="mb-1 mb-3" style="color: black">Enter Your Details</h5>
                                  {{-- <p class="mb-4">Enter your personal information to get closer to copanies</p> --}}
    
                                  <div class="row g-3">
                                      <div class="col-12 col-lg-6">
                                          <label for="email" class="form-label mb-2">Hr Name</label>
                                          <input type="text" class="form-control" name="name" value="{{ $employerprofile->name }}"  id="name" placeholder="Full Name">
                                      </div>
                                      <div class="col-12 col-lg-6">
                                          <label for="email" class="form-label mb-2">Company Name</label>
                                          <input type="text" class="form-control" name="name" value="{{ $employerprofile->name }}"  id="name" placeholder="Full Name">
                                      </div>
                                      ...
                                      <div class="col-12 col-lg-6">
                                        ...
                                        <input class="form-control form-control-sm" value="{{$employerprofile->phone}}" id="image" type="text">
                                    </div>
                                      <div class="col-12 col-lg-6">
                                        <label for="email" class="form-label mb-2">Email</label>
                                        <input type="text" class="form-control" name="email" value="{{$employerprofile->email}}" id="email" placeholder="email">
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <label for="state" class="form-label mb-2">state</label>
                                        <input type="text" class="form-control" name="state" value="{{$employerprofile->state}}"  id="state" placeholder="state">
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <label for="city" class="form-label mb-2">City</label>
                                        <input type="text" class="form-control" name="city" value="{{$employerprofile->city}}"  id="city" placeholder="city">
                                    </div>
