...
<div class="pageTitle">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="breadCrumb"><a href="http://localhost/eudyoga.in/index">Home</a> / <span>Company Detail
                    </span>
                </div>
            </div>
        </div>
...
<div class="container">
    <div class="job-header">
                ...
                <div class="col-md-8 col-sm-8">
                    ...
                    <div class="candidateinfo">
                        ...
                        <div class="userPic"><a href="http://localhost/eudyoga.com/company/bcs-54"><img
                                    src="https://eudyoga.com/public/admin_assets/no-image.png" alt=""
                                    title=""></a>

                        </div>

                        <div class="title">{{ $get_featured_companies->c_name }}</div>
                        ...
                        <div class="loctext"><i class="fa fa-map-marker" aria-hidden="true"></i>
                            ...
                            {{ $get_featured_companies->location }}</div>
        ...
        <div class="jobButtons"> <a href="http://localhost/eudyoga.com/add-to-favourite-company/bcs-54"
                class="btn"><i class="fa fa-floppy-o" aria-hidden="true"></i> Add to Favourite</a> <a
                href="http://localhost/eudyoga.com/report-abuse-company/bcs-54" class="btn report"><i
                    class="fa fa-exclamation-triangle" aria-hidden="true"></i> Report Abuse</a> <a href="javascript:;"
                onclick="send_message()" class="btn"><i class="fa fa-envelope" aria-hidden="true"></i> Send
                Message</a> </div>
                ...
                <div class="jobdetail">
                    ...
                    <ul class="jbdetail">
                        ...
                        <li class="row">
                            ...
                            <div class="col-md-6 col-xs-6"><span>{{ $get_featured_companies->email }}</span></div>
                        ...
                        <li class="row">
                            ...
                            <div class="col-md-6 col-xs-6"><span>{{ $get_featured_companies->no_of_employees }}</span>
                            </div>
                        </li>
                        ...
                        <li class="row">
                            ...
                            <div class="col-md-6 col-xs-6"><span>{{ $get_featured_companies->established_in }}</span>
                            </div>
                        </li>
                        ...
                        <li class="row">
                            ...
                            <div class="col-md-6 col-xs-6">
                                <span>{{ $get_featured_companies->availed_jobs_quota }}</span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <ul class="quicklinks">
                                ...
                                <!--<li><a href="https://103.154.233.105:2003/mail/" target="_blank">EMAIL ID LOGIN</a>-->
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="bttxt">Copyright &copy; 2024 E-Udyoga. All Rights Reserved. Design by: <a
                                href="https://npgroups.com/"
                                target="_blank">npgroups</a></div>
                    </div>
                    <!--<div class="col-md-4">-->
