...
<head>
    ...
    <link href="{{ URL::to('/') }}/assets/admin_assets/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css" rel="stylesheet" type="text/css" />

    <link href="{{ URL::to('/') }}/assets/admin_assets/global/plugins/select2/css/select2.min.css" rel="stylesheet" type="text/css" />

    <link href="{{ URL::to('/') }}/assets/admin_assets/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
...
@include('candidate/layouts_dashboard.header')

        @yield('content')
      

 @include('candidate/layouts_dashboard.slider')
