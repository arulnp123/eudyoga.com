...
<div class="authpages">
       ...
       <div class="row">
          <div class="col-lg-5">
                ...
                <div class="userccount whitebg">
                   <h4 class="text-center pb-2">Candidate Register Form</h4>
                   <div class="tab-content">
                      <div id="candidate" class="formpanel mt-0 tab-pane active">
                         <form class="form-horizontal" id="company_register"  action="{{url('/candidatepost')}} " method="POST" >
                           @csrf
                          
                            <input type="hidden" name="candidate_or_employer" value="candidate" />
                            <div class="formrow">
                               <input type="text" id="name" name="name" class="form-control txtOnly" required="required" placeholder="Name" value="">
                            ...
                            <div class="formrow">
                               <input type="text" name="refrence" class="form-control"  placeholder="Reference" value="">
                            </div>
                            <!--<div class="formrow">-->
                            ...
                            <!--</div>-->
                            <!--<div class="form-group col-12 col-sm-12 col-md-10 text-center mx-auto mobile-padding-no ">-->
   ...
   $( document ).ready(function() {
                $( ".txtOnly" ).keypress(function(e) {
                   ...
                   <!-- sign up form -->
                   <div class="newuser"><i class="fas fa-user" aria-hidden="true"></i> Have Account?<a href="{{url('/candidate_login')}}">Sign in</a></div>
                   <!-- sign up form end--> 
                </div>
             </div>
          </div>
          <div class="col-lg-7">
             <div class="loginpageimg"><img src="{{ URL::to('/candidate_login') }}/assets/images/login-page-banner.png" alt=""></div>
          </div>
       </div>
    </div>
 </div>
          ...
          <div class="modal-content">        
             ...
             <div class="modal-body">        
               <div class="form-group">
                 <input type="hidden" name="_token" value="wf92gEzv5MvhnWl0HXPEaDnWDxKuc9Q5hOMnPnR8">                 <div id="modelemail" class="help-block"> </div>
