        ...
        <div class="row"> 
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul class="quicklinks">
                    ...
                    <li class="postad"><a href="{{ url('/jobs') }}">Post a Job</a></li>
                    <li><a href="{{ url('/') }}">FAQs</a></li>
                                        
                    <li class=""><a href="{{ url('/about_us') }}">About Us</a></li>
                                        
                    <li class=""><a href="{{ url('/Terms_And_Conditions') }}">Terms &amp; Conditions</a></li>
                                        
                    <li class=""><a href="{{ url('/Privacy_Policy') }}">Privacy Policy</a></li>
                                        
                    <li class=""><a href="{{ url('/Refund_Policy') }}">Refund_Policy</a></li>
