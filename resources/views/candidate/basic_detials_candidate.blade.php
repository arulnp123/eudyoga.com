                                ...
                                <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger1">
                                  ...
                                  <div class="row g-3">
                                      <div class="col-12 col-lg-6">
                                          ...
                                          <input type="text" class="form-control" name="name" value="{{ $candidateprofile->name }}"  id="name" placeholder="Full Name">
                                      </div>
                              
                                      
                                      <div class="col-12 col-lg-6">
                                        <label for="image" class="form-label mb-2">Whatsapp Number</label>
                                        <input class="form-control form-control-sm" value="{{$candidateprofile->phone}}" id="image" type="text">
                                    </div>
                                      <div class="col-12 col-lg-6">
                                        <label for="email" class="form-label mb-2">Email</label>
                                        <input type="text" class="form-control" name="email" value="{{$candidateprofile->email}}" id="email" placeholder="email">
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <label for="state" class="form-label mb-2">state</label>
                                        <input type="text" class="form-control" name="state" value="{{$candidateprofile->state}}"  id="state" placeholder="state">
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <label for="city" class="form-label mb-2">City</label>
                                        <input type="text" class="form-control" name="city" value="{{$candidateprofile->city}}"  id="city" placeholder="city">
                                    </div>
