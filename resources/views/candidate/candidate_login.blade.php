           ...
           <div class="userccount whitebg">
               ...
               <div class="tab-content">
                   <div id="candidate">
                       ...
                       <form class="form-horizontal" method="POST" action="{{url('/checkloginn')}}">
                          @csrf
                           ...
                           <div class="formpanel">
                               ...
                               <div class="mb-3"><i class="fas fa-lock" aria-hidden="true"></i> Forgot Your Password? <a href="{{url('password/reset')}}">Click here</a></div>          
                               <input type="submit" class="btn" value="Login">
                           </div>
                           <!-- login form  end--> 
                       </form>
                       <!-- sign up form -->
               <div class="newuser"><i class="fa fa-user" aria-hidden="true"></i> New User? <a href="{{url('candidate_register')}}">Register Here</a></div>
            ...
            <div class="col-lg-7">
            <div class="loginpageimg"><img src="https://eudyoga.com/public/assets/images/login-page-banner.png" alt=""></div>
            </div>
