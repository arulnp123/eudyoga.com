                                    ...
                                    <div class="formpanel">
                                        <div class="formrow">
                                            <input id="email" type="email" class="form-control" name="email"
                                                value="" required autofocus placeholder="Email Address">
                                        </div>
                                        <div class="formrow">
                                            <input id="password" type="password" class="form-control" name="password"
                                                value="" required placeholder="Password">
                                        </div>
                                        <div class="mb-3"><i class="fas fa-lock" aria-hidden="true"></i> Forgot Your
                                            Password? <a href="{{ url('password/reset') }}">Click here</a></div>
                                        <input type="submit" class="btn" value="Login">
                                    </div>
                                    <!-- login form  end-->
                                </form>
                                <!-- sign up form -->
                                <div class="newuser"><i class="fa fa-user" aria-hidden="true"></i> New User? <a
                                        href="{{ url('candidate_register') }}">Register Here</a></div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul class="quicklinks">
                    ...
                    <li class=""><a href="https://eudyoga.com/cms/Terms_And_Conditions">Terms &amp; Conditions</a>
                    </li>
